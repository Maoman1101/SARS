...
table.insert(recipes, make_alt_recipe("advanced-circuit", "etched-adv-circuits",
  ...
  4.0, "crafting-with-fluid"))
  
table.insert(recipes, make_alt_recipe("coal", "charcoal",
  { {type = "item", name = "wood", amount = 3} },
  { {type = "item", name = "coal", amount = 2} },
  10.0, "advanced-crafting"))

table.insert(recipes, make_alt_recipe("electronic-circuit", "plastic-circuits",
  { {type = "item", name = "plastic-bar", amount = 1}, {type = "item", name = "copper-cable", amount = 3} },
  { {type = "item", name = "electronic-circuit", amount = 1} },
  0.5, "advanced-crafting"))

table.insert(recipes, make_alt_recipe("lubricant", "water-based-lubricant",
  { {type = "fluid", name = "water", amount = 10}, {type = "fluid", name = "petroleum-gas", amount = 10} },
  { {type = "fluid", name = "lubricant", amount = 10} },
  1.0, "chemistry"))

table.insert(recipes, make_alt_recipe("low-density-structure", "quick-and-dirty-structure",
  { {type = "item", name = "copper-plate", amount = 25}, {type = "item", name = "plastic-bar", amount = 8},
    {type = "item", name = "steel-plate", amount = 3}, {type = "item", name = "coal", amount = 1} },
  { {type = "item", name = "low-density-structure", amount = 1} },
  5.0, "advanced-crafting"))

table.insert(recipes, make_alt_recipe("uranium-fuel-cell", "trace-uranium-filtering",
  { {type = "item", name = "uranium-238", amount = 100}, {type = "item", name = "coal", amount = 1} },
  { {type = "item", name = "uranium-235", amount = 1} },
  60.0, "advanced-crafting"))

table.insert(recipes, make_alt_recipe("rocket-fuel", "electrolysis-fuel",
  { {type = "fluid", name = "water", amount = 100}, {type = "fluid", name = "light-oil", amount = 10} },
  { {type = "item", name = "rocket-fuel", amount = 1} },
  2.0, "chemistry"))

table.insert(recipes, make_alt_recipe("explosives", "nitroglycerin",
  { {type = "fluid", name = "light-oil", amount = 1}, {type = "item", name = "sulfur", amount = 1}, {type = "fluid", name = "water", amount = 10} },
  { {type = "item", name = "explosives", amount = 2} },
  4.0, "chemistry"))

table.insert(recipes, make_alt_recipe("explosives", "plastic-c4",
  { {type = "fluid", name = "petroleum-gas", amount = 1}, {type = "item", name = "sulfur", amount = 1}, {type = "item", name = "plastic-bar", amount = 1} },
  { {type = "item", name = "explosives", amount = 3} },
  5.0, "chemistry"))

table.insert(recipes, make_alt_recipe("flying-robot-frame", "lightweight-robot-frame",
  { {type = "item", name = "plastic-bar", amount = 2}, {type = "item", name = "battery", amount = 2},
    {type = "item", name = "electronic-circuit", amount = 2}, {type = "item", name = "electric-engine-unit", amount = 1} },
  { {type = "item", name = "flying-robot-frame", amount = 1} },
  20.0, "advanced-crafting"))

table.insert(recipes, make_alt_recipe("electric-engine-unit", "dry-electric-engine",
  { {type = "item", name = "electronic-circuit", amount = 2}, {type = "item", name = "engine-unit", amount = 1}, {type = "item", name = "coal", amount = 1} },
  { {type = "item", name = "electric-engine-unit", amount = 1} },
  10.0, "advanced-crafting"))

data:extend(recipes)

data:extend({ -- debug commands
  {
    type = "custom-input",
  ...
  {
    type = "custom-input",
    name = "sars-reset-alt-recipes",
    key_sequence = "CONTROL + ALT + Y",
    consuming = "none"
  },
  {
    type = "custom-input",
    name = "sars-open-manual-unlock",
    key_sequence = "CONTROL + ALT + J",
    consuming = "none"
  }
})